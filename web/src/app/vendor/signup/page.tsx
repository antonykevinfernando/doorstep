...
import { ArrowRight, ArrowLeft, Loader2, Store, Search, MapPin, ChevronDown, Check } from 'lucide-react';
...
export default function VendorSignupPage() {
  ...
  function selectAddress(feature: MapboxFeature) {
    ...
    if (!businessName) setBusinessName(feature.text);
  }
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">Marketplace for local vendors</p>
        </div>
        ...
        {step === 1 && (
          <div className="glass-strong rounded-2xl p-8">
            <div className="flex items-center gap-3 mb-1">
              <Store size={20} className="text-foreground/70" />
              <h2 className="text-lg font-semibold">Your account</h2>
            </div>
            <p className="text-sm text-muted-foreground mb-6">
              Sign up to list deals for residents in your neighbourhood.
            </p>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="jane@business.com" />
              </div>
              <div className="space-y-2">
        ...
        {step === 2 && (
          <form onSubmit={handleSubmit}>
            <div className="glass-strong rounded-2xl p-8">
              <h2 className="text-lg font-semibold mb-1">Business details</h2>
              <p className="text-sm text-muted-foreground mb-6">
                Tell residents about your business.
              </p>

              <div className="space-y-4">
                <div className="space-y-2">
                  <Label>Business name</Label>
                  <Input value={businessName} onChange={(e) => setBusinessName(e.target.value)} placeholder="e.g. Fresh Bites Cafe" />
                </div>
                <div className="space-y-2">
        ...
        <p className="text-xs text-center text-muted-foreground mt-8">
          Are you a mover? <Link href="/mover/signup" className="underline font-medium text-foreground/80">Sign up here</Link>
        </p>
      </div>
    </div>
  );
