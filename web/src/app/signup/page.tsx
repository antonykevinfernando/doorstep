...
import { ArrowRight, ArrowLeft, MapPin, Building2, Search, Loader2 } from 'lucide-react';
...
export default function SignupPage() {
  ...
  const searchMapbox = useCallback(async (query: string) => {
    ...
    try {
      ...
      if (data.features) {
        setMapboxResults(
          data.features.map((f: any) => ({ id: f.id, place_name: f.place_name, text: f.text }))
        );
      }
    } catch {
      setMapboxResults([]);
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!selectedAddress) { setError('Please search and select your building address'); return; }
    ...
    const { error: signUpError } = await supabase.auth.signUp({
      ...
      options: {
        data: {
          ...
          building_name: buildingName.trim() || orgName.trim(),
          building_address: selectedAddress,
        },
      },
    });
    if (signUpError) {
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Move management for property teams
          </p>
        </div>
        ...
        {step === 1 && (
          <div className="glass-strong rounded-2xl p-8">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              You're signing up as a property manager or team member.
            </p>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="jane@maplerealty.com"
                />
              </div>
              <div className="space-y-2">
        ...
        {step === 2 && (
          <form onSubmit={handleSubmit}>
            <div className="glass-strong rounded-2xl p-8">
              <h2 className="text-lg font-semibold mb-1">Your property</h2>
              <p className="text-sm text-muted-foreground mb-6">
                Tell us about the building you manage. You can add more later.
              </p>

              <div className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="org">Company / management name</Label>
                  <Input
                    id="org"
                    value={orgName}
                ...
                <div className="space-y-2">
                  <Label htmlFor="building">Building name <span className="text-muted-foreground font-normal">(optional)</span></Label>
                  <Input
                    id="building"
                    value={buildingName}
                    onChange={(e) => setBuildingName(e.target.value)}
                    placeholder="The Willows"
                  />
                </div>
                ...
                <div className="space-y-2 relative">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      onFocus={() => { if (mapboxResults.length > 0 && !selectedAddress) setShowDropdown(true); }}
                  ...
                  {selectedAddress && (
                    <div className="flex items-center gap-2 text-sm bg-sage/30 text-foreground/80 rounded-lg px-3 py-2">
                  ...
                  {showDropdown && mapboxResults.length > 0 && !selectedAddress && (
